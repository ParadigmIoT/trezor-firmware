...
#define OPTIGA_I2C_1_PORT GPIOG
#define OPTIGA_I2C_1_SDA_PIN GPIO_PIN_13
#define OPTIGA_I2C_1_SCL_PIN GPIO_PIN_14
#define OPTIGA_I2C_1_CLK_EN __HAL_RCC_GPIOG_CLK_ENABLE
#define OPTIGA_ALTERNATE_FUNCTION GPIO_AF4_I2C1
#define OPTIGA_RST_PORT GPIOA
#define OPTIGA_RST_PIN GPIO_PIN_4
#define OPTIGA_RST_CLK_EN __HAL_RCC_GPIOA_CLK_ENABLE

// If optiga power is controlled by a GPIO pin is needed, define the following:
// #define OPTIGA_PWR_PORT 
// #define OPTIGA_PWR_PIN 
// #define OPTIGA_PWR_CLK_EN 
